            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                ...
                <div class="text-end">
                    <ol class="breadcrumb m-0 py-0">
                        <li class="breadcrumb-item"><a href="{{ route('all.supplier') }}">Zurück</a></li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="myForm" class="row g-3" action="{{ route('store.warehouse') }}" method="post" enctype="multipart/form-data">
                                @csrf

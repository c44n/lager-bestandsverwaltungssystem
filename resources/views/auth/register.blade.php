                            ...
                            <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                ...
                                <div class="pt-0">
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="saprator my-4"><span>Oder logge dich ein</span></div>

                                        <div class="text-center text-muted mb-4">
                                            <p class="mb-0">Du hast bereits einen Account ?<a
                ...
                <div class="col-xl-7">
                    <div class="account-page-bg p-md-5 p-4">
                        <div class="text-center">
                            <h3 class="text-dark mb-3 pera-title">Lager-Bestandsverwaltungssystem</h3>
